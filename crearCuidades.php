...
.text-info{
  ...
  color:white;
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12">
            <h2 class="text-center"><a href=<?php print_r($botonera["url"]["galeria"]);?>> Galeria</a><h2>
                <h1 class="page-header">Agregar Nueva Cuidad</h1>
            </div>
        </div>
        ...
        <div class="row">
          ...
          <a href="panel.php" class="btn btn-primary btn-sm pull-right">
                ...
                <div class="form-group">
                    <label>Nombre</label>
                    <input type="text" placeholder="Ingrese nombre de la cuidad" name="nombre" <?php if (empty($_GET["nombre"])){echo "value=''"; }elseif(isset($_GET["nombre"])){echo "value=".$_GET["nombre"];} ?> 
               class="form-control">
                </div>
           <?php 
           ...
           ?>
                <div class="form-group">
                    ...
                    <select name="categoria"  class="form-control">
                          <option value="Cuidades" >Cuidades</option>
