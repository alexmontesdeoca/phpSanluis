...
.text-info{
  ...
  color:white;
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12">
                <h1 class="page-header">Agregar Nuevo Hotel</h1>
            </div>
        </div>
        ...
        <div class="row">
          ...
          <a href="panel.php" class="btn btn-primary btn-sm pull-right">
                ...
                <div class="form-group">
                    <label>Nombre</label>
                    <input type="text" placeholder="Ingrese nombre del Hotel" name="nombre" <?php if (empty($_GET["nombre"])){echo "value=''"; }elseif(isset($_GET["nombre"])){echo "value=".$_GET["nombre"];} ?> 
               class="form-control">
                </div>
           <?php 
